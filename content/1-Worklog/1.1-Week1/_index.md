...
### Week 1 Objectives:
* Register on HCM Portal and set up AWS account.
* Complete onboarding tasks for the AWS Workforce Bootcamp program.
* Activate AWS Credits and configure AWS Budgets alarms.
* Learn foundational AWS Cloud services.
...
* Configured AWS Budgets to prevent unexpected cloud costs.
* Mastered basic cloud concepts and gained proficiency in draw.io architecture diagramming.